...
export default function AcademyClientsPage() {
  ...
  const [selectedClient, setSelectedClient] = useState<AcademyClient | null>(
    null,
  );
  ...
  const handleDeleteClient = () => {
    ...
    // later → call API
    // await fetch(`/api/Academy-clients/${deleteClient.id}`, { method: "DELETE" })
  ...
  const filteredClients = useMemo(() => {
    return AcademyClients.filter((client) =>
  ...
  return (
    <main className="p-6">
      <h2 className="text-2xl font-semibold mb-6">Verbum Networks Students</h2>
      <div className="flex justify-between items-center mb-4">
        <input
          type="text"
          placeholder="Search Academy clients..."
          value={search}
          onChange={(e) => {
          ...
          <tbody>
            {paginatedClients.map((client) => (
              <tr key={client.id} className="border-t hover:bg-gray-50">
                ...
                <td className="p-3">{client.enrollmentDay}</td>
          ...
          >
            ...
            >
              ...
              <div className="space-y-2 text-sm mb-6">
                ...
                <p>
                  <strong>Guardian:</strong> {selectedClient.Guadian}
                </p>
                <p>
                  <strong>Address:</strong> {selectedClient.address}
                </p>
                <p>
                  <strong>Duration:</strong> {selectedClient.Duration}
                </p>
                <p>
                  <strong>Amount Paid:</strong>
                  <br />₦{selectedClient.amountPaid.toLocaleString()}
                </p>
                <p>
                  <strong>Balance:</strong>
                  <br />₦{selectedClient.balance?.toLocaleString() || 0}
                </p>
              </div>
              ...
              <div className="flex items-center justify-end gap-3">
                <button
                  onClick={() =>
                    router.push(`/dashboard/academy/${selectedClient.id}/edit`)
                  }
          ...
          >
            ...
            >
              ...
              <p className="text-sm mb-6">
                ...
                <strong>{deleteClient.name}</strong>? This action cannot be
                undone.
              </p>
