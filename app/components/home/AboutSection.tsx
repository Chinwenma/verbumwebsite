...
const AboutSection = () => {
  return (
    <section className="w-full py-16 px-4 md:px-20 bg-secondary-light">
    ...
    Verbum Networks is an Information and Communications Technology
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <Link href="/about">
              <button className="bg-[#ff0000] text-white hover:bg-orange-600 transition-all 200 px-5 py-2 rounded-md">
                Learn More
              </button>
            </Link>
          </div>
